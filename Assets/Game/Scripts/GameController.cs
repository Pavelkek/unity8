...
public class GameController : MonoBehaviour
{
    ...
    private void GameWon()
    {
        ...
        pauseCameraObject.SetActive(false);
        gameOverCameraObject.SetActive(true);
        mainCameraObject.GetComponent<Camera>().depth = 0;
        pauseCameraObject.GetComponent<Camera>().depth = 0;
        gameOverCameraObject.GetComponent<Camera>().depth = 1;
    }

    private void GameLost()
    {
        Debug.Log("GameController.GameLost: ");
        gameOverText.GetComponent<TextMeshProUGUI>().text = "You lose";
        mainCameraObject.SetActive(false);
        pauseCameraObject.SetActive(false);
        gameOverCameraObject.SetActive(true);
        mainCameraObject.GetComponent<Camera>().depth = 0;
    ...
    public void Pause()
    {
        mainCameraObject.SetActive(false);
        gameOverCameraObject.SetActive(false);
        pauseCameraObject.SetActive(true);
        mainCameraObject.GetComponent<Camera>().depth = 0;
        gameOverCameraObject.GetComponent<Camera>().depth = 0;
        pauseCameraObject.GetComponent<Camera>().depth = 1;
    }
}